...
:url-repo: https://github.com/hyperpolymath/asdf-franklin-plugin
...
image:https://img.shields.io/github/license/hyperpolymath/asdf-franklin-plugin?style=flat-square[License,link=LICENSE]
image:https://img.shields.io/github/v/release/hyperpolymath/asdf-franklin-plugin?style=flat-square[Release,link={url-repo}/releases]
image:https://img.shields.io/github/actions/workflow/status/hyperpolymath/asdf-franklin-plugin/ci.yml?branch=main&style=flat-square[Build Status,link={url-repo}/actions]
image:https://img.shields.io/badge/asdf-plugin-blue?style=flat-square[asdf Plugin,link={url-asdf}]

[.lead]
An {url-asdf}[asdf] plugin to install and manage {url-tool}[Franklin] versions.
...
Franklin is an upstream tool managed by this plugin. Refer to the official
...
|**Version Switching**
|Switch between Franklin versions per project

|**Project Isolation**
|Pin Franklin per repository via `.tool-versions`

|**Reproducible Builds**
|Align CI/CD and developer environments to the same Franklin version
...
=== Installing Franklin Versions

[source,bash]
----
asdf list all franklin
asdf install franklin latest
asdf install franklin 0.1.0
----
...
[source,bash]
----
asdf global franklin 0.1.0
asdf local franklin 0.1.0
asdf current franklin
franklin --version
----
...
* Ensure `franklin` is on PATH after installation.
* Verify the installed version with `franklin --version`.
